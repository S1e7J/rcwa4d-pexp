\section{PMMA Dopping + FeCl3 thickness 200}
...
\hrule
\vspace{1em}
\subsection*{Material ID: Dopping: 10}
\textbf{Constante Dieléctrica ($\epsilon_{total}$):} 2.50 \\[0.5em]
\begin{table}[h!]
\centering
\begin{tabular}{lcc}
\toprule
...
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{figures/Dopping: 10_plate.png}
\hfill
\includegraphics[width=0.48\textwidth]{figures/Dopping: 10_rod.png}
\caption{Estructuras de bandas fotónicas ($k_x$) para Dopping: 10. Izquierda: Lámina. Derecha: Cilindros.}
\end{figure}
\vspace{1em}
\begin{figure}[H]
\centering
\includegraphics[width=0.48\textwidth]{figures/Dopping: 10_plate_rangle.png}
\hfill
\includegraphics[width=0.48\textwidth]{figures/Dopping: 10_rod_rangle.png}
\caption{Mapas de transmisión por rotación (twist) para Dopping: 10. Izquierda: Lámina. Derecha: Cilindros.}
\end{figure}
\vspace{1em}
\hrule
\vspace{1em}
\subsection*{Material ID: Dopping: 2}
\textbf{Constante Dieléctrica ($\epsilon_{total}$):} 2.51 \\[0.5em]
\begin{table}[h!]
\centering
\begin{tabular}{lcc}
\toprule
...
\textbf{Constante Dieléctrica ($\epsilon_{total}$):} 2.49 \\[0.5em]
\begin{table}[h!]
\centering
\begin{tabular}{lcc}
\toprule
...
\textbf{Constante Dieléctrica ($\epsilon_{total}$):} 2.48 \\[0.5em]
\begin{table}[h!]
\centering
\begin{tabular}{lcc}
\toprule
